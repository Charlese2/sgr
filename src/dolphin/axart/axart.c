...
void AXARTInitSound(AXART_SOUND* sound, AXVPB* voice, u32 sampleRate) {
    ASSERTLINE(131, sound);
    ASSERTLINE(132, voice);
...
void AXARTAddSound(AXART_SOUND* sound) {
    ...
    ASSERTLINE(157, sound);
    ASSERTLINE(158, sound->axvpb);
